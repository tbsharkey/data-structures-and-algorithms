...
const sortByLength = (arr) => {
  eturn arr.sort((a, b) => a.length - b.length);
};
...
const sortMeetingsByDay = (arr) => {
  return arr.sort((a, b) => dayOfWeekToNumber(a.dayOfWeek) - dayOfWeekToNumber(b.dayOfWeek));
};
...
const sortSchedule = (arr) => {
  return arr.sort((a, b) => {
    if (a.dayOfWeek !== b.dayOfWeek) {
      ...
      return meetingDuration(a) - meetingDuration(b);
    }
  });
};
